/*******************************************************************************
* PSoC 101 Training Lessons: I2CTransmit-Test
********************************************************************************
*
* Allow an I2C master (Bridge Control Panel) to sample the PWM compare value so
* that it can display the triangle pattern of the counter value. This version
* has a one-byte buffer (max is 255).
*
* Note: PWM component output is now center-aligned so the pattern is a triangle.
*
*/
