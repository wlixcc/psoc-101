// ======================================================================
// 14-StatusRegister.v generated from TopDesign.cysch
// 12/26/2019 at 11:57
...
module top ;
    ...
    assign Net_2215 = 1'h1;

    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_2141)
    begin
        cy_tff_2 <= Net_2215^Net_2164;
    end
    assign Net_2164 = cy_tff_2;
    // -- TFF End --
	...
	cy_psoc3_pins_v1_10
		#(.id("83e46241-4e5d-4b97-9697-423e74265fec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c668deb5-12ec-451b-b6e4-b31d88cf82d4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_2140)
    begin
        cy_tff_1 <= Net_2212^Net_2141;
    end
    assign Net_2141 = cy_tff_1;
    // -- TFF End --


    assign Net_2140 = ~Net_2217;
