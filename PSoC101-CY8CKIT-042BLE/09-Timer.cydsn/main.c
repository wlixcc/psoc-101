/*******************************************************************************
* PSoC 101 Training Lessons: Timer
********************************************************************************
*
* Measure the time that SW2 is pressed using a Timer. Set the PWM compare value
...
*
* Note: The start and reload terminals act on a falling edge, stop and capture
* on a rising edge.
*
*/
...
********************************************************************************
*
* The switch has been released so copy the Timer counter value into the PWM
* compare. If the switch was pressed for more than 10s, simply set the compare
* to the maximum.
*
* Parameters:	None
*
