...
#define CapSense_1_INDEX_TABLE_SIZE              (0u)
...
#define CapSense_1_COMPLEX_SCANSLOTS_NUM      (0u)
#define CapSense_1_DEDICATED_SENSORS_NUM      (0u)
#define CapSense_1_PORT_PIN_CONFIG_TBL_ZISE   (5u)
...
#define CapSense_1_GLITCH_ELIMINATION_TIMEOUT     (0u)
...
#define CapSense_1_MSB_RESOLUTION_OFFSET      (22u)
#define CapSense_1_RESOLUTIONS_TBL_SIZE       (1u)
...
#define CapSense_1_CFG_REG_TBL_SIZE           (7u)
...
#define CapSense_1_CSD_TRIM1_REG          (*(reg32 *) CapSense_1_IDAC1_cy_psoc4_idac__CSD_TRIM1)
#define CapSense_1_CSD_TRIM1_PTR          ( (reg32 *) CapSense_1_IDAC1_cy_psoc4_idac__CSD_TRIM1)

#define CapSense_1_CSD_TRIM2_REG          (*(reg32 *) CapSense_1_IDAC1_cy_psoc4_idac__CSD_TRIM2)
#define CapSense_1_CSD_TRIM2_PTR          ( (reg32 *) CapSense_1_IDAC1_cy_psoc4_idac__CSD_TRIM2)

#if (2u == CapSense_1_M0S8CSD_BLOCK_CNT)
    #if (CapSense_1_CSD_FFB__CSD_NUMBER != 1u)
    ...
    #else
        #define CapSense_1_SFLASH_CSD_TRIM1_REG   (*(reg8 *) CYREG_SFLASH_CSD1_TRIM1_CSD)
        #define CapSense_1_SFLASH_CSD_TRIM1_PTR   ( (reg8 *) CYREG_SFLASH_CSD1_TRIM1_CSD)

        #define CapSense_1_SFLASH_CSD_TRIM2_REG   (*(reg8 *) CYREG_SFLASH_CSD1_TRIM2_CSD)
        #define CapSense_1_SFLASH_CSD_TRIM2_PTR   ( (reg8 *) CYREG_SFLASH_CSD1_TRIM2_CSD)
    #endif /* (CapSense_1_CSD_FFB__CSD_NUMBER != 1u) */
#else
    #define CapSense_1_SFLASH_CSD_TRIM1_REG   (*(reg8 *) CYREG_SFLASH_CSD_TRIM1_CSD)
    #define CapSense_1_SFLASH_CSD_TRIM1_PTR   ( (reg8 *) CYREG_SFLASH_CSD_TRIM1_CSD)
    ...
    #define CapSense_1_SFLASH_CSD_TRIM2_REG   (*(reg8 *) CYREG_SFLASH_CSD_TRIM2_CSD)
    #define CapSense_1_SFLASH_CSD_TRIM2_PTR   ( (reg8 *) CYREG_SFLASH_CSD_TRIM2_CSD)
#endif /* (2u == CapSense_1_M0S8CSD_BLOCK_CNT) */
...
#define CapSense_1_PORT_SEL5_REG          (*(reg32 *) CYREG_HSIOM_PORT_SEL5 )
#define CapSense_1_PORT_SEL5_PTR          (*(reg32 *) CYREG_HSIOM_PORT_SEL5 )

#define CapSense_1_PORT_SEL6_REG          (*(reg32 *) CYREG_HSIOM_PORT_SEL6 )
#define CapSense_1_PORT_SEL6_PTR          (*(reg32 *) CYREG_HSIOM_PORT_SEL6 )
...
#define CapSense_1_PORT5_PC_REG          (*(reg32 *) CYREG_GPIO_PRT5_PC )
#define CapSense_1_PORT5_PC_PTR          (*(reg32 *) CYREG_GPIO_PRT5_PC )

#define CapSense_1_PORT6_PC_REG          (*(reg32 *) CYREG_GPIO_PRT6_PC )
#define CapSense_1_PORT6_PC_PTR          (*(reg32 *) CYREG_GPIO_PRT6_PC )
...
#define CapSense_1_PORT5_DR_REG          (*(reg32 *) CYREG_GPIO_PRT5_DR )
#define CapSense_1_PORT5_DR_PTR          (*(reg32 *) CYREG_GPIO_PRT5_DR )

#define CapSense_1_PORT6_DR_REG          (*(reg32 *) CYREG_GPIO_PRT6_DR )
#define CapSense_1_PORT6_DR_PTR          (*(reg32 *) CYREG_GPIO_PRT6_DR )



#define CapSense_1_CMOD_CONNECTION_REG        (*(reg32 *) CapSense_1_Cmod__0__HSIOM)
#define CapSense_1_CMOD_PORT_PC_REG           (*(reg32 *) CapSense_1_Cmod__0__PC)
#define CapSense_1_CMOD_PORT_DR_REG           (*(reg32 *) CapSense_1_Cmod__0__DR)

#define CapSense_1_CTANK_CONNECTION_REG       (*(reg32 *) CapSense_1_Csh_tank__0__HSIOM)
#define CapSense_1_CTANK_PORT_PC_REG          (*(reg32 *) CapSense_1_Csh_tank__0__PC)
#define CapSense_1_CTANK_PORT_DR_REG          (*(reg32 *) CapSense_1_Csh_tank__0__DR)
...
#define CapSense_1_AMUXA_CONNECTION_MODE          (0x00000006Lu)
#define CapSense_1_AMUXB_CONNECTION_MODE          (0x00000007Lu)

#define CapSense_1_CSD_PIN_MODE_MASK              (0x00000007Lu)
#define CapSense_1_CSD_PIN_DRIVE_MASK             (0x00000001Lu)

#define CapSense_1_CSD_PIN_DM_STRONG              (0x00000006Lu)
#define CapSense_1_CSD_PIN_DM_HIGH_Z              (0x00000000Lu)

#define CapSense_1_CSD_CMOD_CONNECTION_MASK   (uint32)(CapSense_1_Cmod__0__HSIOM_MASK)
#define CapSense_1_CSD_CMOD_TO_AMUXBUS_A      (uint32)(CapSense_1_AMUXA_CONNECTION_MODE << CapSense_1_Cmod__0__HSIOM_SHIFT)
#define CapSense_1_CSD_CMOD_TO_AMUXBUS_B      (uint32)(CapSense_1_AMUXB_CONNECTION_MODE << CapSense_1_Cmod__0__HSIOM_SHIFT)

#if(0u != CapSense_1_CSH_TANK_ENABLE)
    #define CapSense_1_CSD_CTANK_CONNECTION_MASK  (uint32)(CapSense_1_Csh_tank__0__HSIOM_MASK)
    #define CapSense_1_CSD_CTANK_TO_AMUXBUS_A     (uint32)(CapSense_1_AMUXA_CONNECTION_MODE << CapSense_1_Csh_tank__0__HSIOM_SHIFT)
    #define CapSense_1_CSD_CTANK_TO_AMUXBUS_B     (uint32)(CapSense_1_AMUXB_CONNECTION_MODE << CapSense_1_Csh_tank__0__HSIOM_SHIFT)
#endif /* (0u != CapSense_1_CSH_TANK_ENABLE) */

#define  CapSense_1_CSD_CMOD_PC_MASK          (uint32)(CapSense_1_CSD_PIN_MODE_MASK <<\
                                                            ((uint32)CapSense_1_Cmod__0__SHIFT * CapSense_1_PC_PIN_CFG_SIZE))
#define  CapSense_1_CMOD_PC_STRONG_MODE       (uint32)(CapSense_1_CSD_PIN_DM_STRONG <<\
                                                            ((uint32)CapSense_1_Cmod__0__SHIFT * CapSense_1_PC_PIN_CFG_SIZE))
#define  CapSense_1_CMOD_PC_HIGH_Z_MODE       (uint32)(CapSense_1_CSD_PIN_DM_HIGH_Z <<\
                                                            ((uint32)CapSense_1_Cmod__0__SHIFT * CapSense_1_PC_PIN_CFG_SIZE))

#if(0u != CapSense_1_CSH_TANK_ENABLE)
    #define  CapSense_1_CSD_CTANK_PC_MASK         (uint32)(CapSense_1_CSD_PIN_MODE_MASK <<\
                                                                ((uint32)CapSense_1_Csh_tank__0__SHIFT * CapSense_1_PC_PIN_CFG_SIZE))
    #define  CapSense_1_CTANK_PC_STRONG_MODE      (uint32)(CapSense_1_CSD_PIN_DM_STRONG <<\
                                                                ((uint32)CapSense_1_Csh_tank__0__SHIFT * CapSense_1_PC_PIN_CFG_SIZE))
    #define  CapSense_1_CTANK_PC_HIGH_Z_MODE      (uint32)(CapSense_1_CSD_PIN_DM_HIGH_Z <<\
                                                                ((uint32)CapSense_1_Csh_tank__0__SHIFT * CapSense_1_PC_PIN_CFG_SIZE))
#endif /* (0u != CapSense_1_CSH_TANK_ENABLE) */

#define  CapSense_1_CMOD_DR_VSSIO             (uint32)(CapSense_1_Cmod__0__MASK)
#define  CapSense_1_CMOD_DR_VDDIO             (0x00000000Lu)
#define  CapSense_1_CMOD_DR_MASK              (uint32)(CapSense_1_Cmod__0__MASK)

#if(0u != CapSense_1_CSH_TANK_ENABLE)
    #define  CapSense_1_CTANK_DR_VSSIO            (uint32)(CapSense_1_Csh_tank__0__MASK)
    #define  CapSense_1_CTANK_DR_VDDIO            (0x00000000Lu)
    #define  CapSense_1_CTANK_DR_MASK             (uint32)(CapSense_1_Csh_tank__0__MASK)
#endif /* (0u != CapSense_1_CSH_TANK_ENABLE) */
...
/* SmartSense functions */
    ...
    extern uint8 CapSense_1_scanSpeedTbl[((CapSense_1_TOTAL_SENSOR_COUNT - 1u) / 8u) + 1u];
...
extern uint8 CapSense_1_unscannedSnsDriveMode[CapSense_1_PORT_PIN_CONFIG_TBL_ZISE];
extern uint8 CapSense_1_sensorEnableMaskBackup[CapSense_1_TOTAL_SENSOR_MASK];
extern uint8 CapSense_1_sensorEnableMask[CapSense_1_TOTAL_SENSOR_MASK];

#if ((CapSense_1_TUNING_METHOD != CapSense_1__TUNING_NONE) || (0u != CapSense_1_AUTOCALIBRATION_ENABLE))
...
#else
    extern const uint8 CapSense_1_modulationIDAC[CapSense_1_TOTAL_SENSOR_COUNT];
    extern const uint8 CapSense_1_compensationIDAC[CapSense_1_TOTAL_SENSOR_COUNT];
#endif /* ((CapSense_1_TUNING_METHOD != CapSense_1__TUNING_NONE) || (0u != CapSense_1_AUTOCALIBRATION_ENABLE)) */
    ...
    #else
        extern uint8 CapSense_1_senseClkDividerVal;
        extern uint8 CapSense_1_sampleClkDividerVal;
    #endif /* (0u != CapSense_1_MULTIPLE_FREQUENCY_SET) */
#else
    extern const uint32 CapSense_1_widgetResolution[CapSense_1_RESOLUTIONS_TBL_SIZE];
    #if (0u != CapSense_1_MULTIPLE_FREQUENCY_SET)
        extern const uint8 CapSense_1_senseClkDividerVal[CapSense_1_TOTAL_SCANSLOT_COUNT];
        extern const uint8 CapSense_1_sampleClkDividerVal[CapSense_1_TOTAL_SCANSLOT_COUNT];
    #else
        extern const uint8 CapSense_1_senseClkDividerVal;
        extern const uint8 CapSense_1_sampleClkDividerVal;
    #endif /* (0u != CapSense_1_MULTIPLE_FREQUENCY_SET) */
#endif /* (CapSense_1_TUNING_METHOD != CapSense_1__TUNING_NONE)  */

extern const uint8 CapSense_1_widgetNumber[CapSense_1_TOTAL_SENSOR_COUNT];

extern reg32* const CapSense_1_prtSelTbl[CapSense_1_CFG_REG_TBL_SIZE];
extern reg32* const CapSense_1_prtCfgTbl[CapSense_1_CFG_REG_TBL_SIZE];
extern reg32* const CapSense_1_prtDRTbl[CapSense_1_CFG_REG_TBL_SIZE];
extern reg32 * CapSense_1_pcTable[CapSense_1_PORT_PIN_CONFIG_TBL_ZISE];

extern const uint8  CapSense_1_portTable[CapSense_1_PORT_PIN_CONFIG_TBL_ZISE];
extern const uint32 CapSense_1_maskTable[CapSense_1_PORT_PIN_CONFIG_TBL_ZISE];
extern const uint8  CapSense_1_pinShiftTbl[CapSense_1_PORT_PIN_CONFIG_TBL_ZISE];

#if (0u != CapSense_1_INDEX_TABLE_SIZE)
extern const uint8 CYCODE CapSense_1_indexTable[CapSense_1_INDEX_TABLE_SIZE];
#endif /* (0u != CapSense_1_INDEX_TABLE_SIZE)) */
