// ======================================================================
// Lesson14-Status Register.v generated from TopDesign.cysch
// 12/26/2019 at 12:19
...
module top ;
    ...
    assign Net_100 = ~Net_43;

    assign Net_126 = 1'h1;

    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_94)
    begin
        cy_tff_2 <= Net_125^Net_52;
    end
    assign Net_52 = cy_tff_2;
    // -- TFF End --
    ...
    defparam Status_Reg.NumInputs = 2;
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_127)
    begin
        cy_tff_1 <= Net_126^Net_94;
    end
    assign Net_94 = cy_tff_1;
    // -- TFF End --
