// ======================================================================
// Lesson7-Counter.v generated from TopDesign.cysch
// 12/25/2019 at 11:22
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ebb81b78-8451-4037-a176-029e5fba746a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0eb7e9bd-c9d7-41c1-96cf-6ac3994750e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("a55ec9d2-a3f8-4264-b1c0-d657f9376b2c"),
		  .source_clock_id(""),
		  .divisor(0),
