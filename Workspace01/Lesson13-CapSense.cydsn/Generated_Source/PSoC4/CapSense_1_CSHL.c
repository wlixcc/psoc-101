...
uint8 CapSense_1_lowBaselineReset[CapSense_1_TOTAL_SENSOR_COUNT] = {
    30u, 30u, 30u, 30u, 30u, 
};
...
#if (CapSense_1_TUNING_METHOD == CapSense_1__TUNING_AUTO)
    extern CapSense_1_CONFIG_TYPE_P4_v2_60 CapSense_1_config;
#endif  /* (CapSense_1_TUNING_METHOD == CapSense_1__TUNING_AUTO) */

#if (CapSense_1_RAW_FILTER_MASK != 0u)
uint8 CapSense_1_enableRawFilters = CapSense_1_RAW_FILTERS_ENABLED;
#endif  /* (CapSense_1_RAW_FILTER_MASK != 0u) */

/* Generated by Customizer */
uint8 CapSense_1_fingerThreshold[CapSense_1_THRESHOLD_TBL_SIZE];
...
static uint8 CapSense_1_posFiltersMask[] = {
    0x8u, 
};
...
void CapSense_1_UpdateBaselineNoThreshold(uint32 sensor)
{
    ...
    noiseThreshold = CapSense_1_noiseThreshold[widget];
    filteredRawData = CapSense_1_sensorRaw[sensor];

    #if (CapSense_1_RAW_FILTER_MASK != 0u)
    if(CapSense_1_enableRawFilters != 0u)
    {
    ...
    #if (CapSense_1_TUNING_METHOD == CapSense_1__TUNING_AUTO)
        MeasureNoiseEnvelope_P4_v2_60(&CapSense_1_config, (uint8)sensor, CapSense_1_sensorRaw);
    #endif /* (CapSense_1_TUNING_METHOD == CapSense_1__TUNING_AUTO) */
    ...
    #endif /* (CapSense_1_TUNING_METHOD != CapSense_1__TUNING_NONE) */
    {
        if(CapSense_1_lowBaselineResetCnt[sensor] >= CapSense_1_lowBaselineReset[sensor])
        {
            CapSense_1_BaseInit(sensor);
            CapSense_1_lowBaselineResetCnt[sensor] = 0u;
        }
...
void CapSense_1_UpdateWidgetBaseline(uint32 widget)
{
    ...
    firstSensor = CapSense_1_rawDataIndex[widget];

    /* Get last sensor in widget */
    lastSensor = (CapSense_1_rawDataIndex[widget] + sensorsPerWidget);
...
void CapSense_1_DisableWidget(uint32 widget)
{
...
#if(CapSense_1_TOTAL_CENTROIDS_BASIC_COUNT)
    /*******************************************************************************
    ...
    *******************************************************************************/
    ...
    {
        #if ((CapSense_1_TOTAL_LINEAR_SLIDERS_COUNT > 0u) || (CapSense_1_TOTAL_TOUCH_PADS_BASIC_COUNT > 0u))
            uint8 posPrev;
            uint8 posNext;
        #endif /* ((CapSense_1_TOTAL_LINEAR_SLIDERS_COUNT>0u) || (CapSense_1_TOTAL_TOUCH_PADS_BASIC_COUNT>0u)) */

        /* Helps during centroid calculation */
        #if (CapSense_1_TOTAL_CENTROIDS_BASIC_COUNT)
            static uint8 CapSense_1_centroid[3u];
        #endif  /* (CapSense_1_TOTAL_CENTROIDS_BASIC_COUNT) */
...
#if(CapSense_1_TOTAL_TOUCH_PADS_BASIC_COUNT > 0u)
    /*******************************************************************************
...
#endif /* (CapSense_1_TOTAL_TOUCH_PADS_BASIC_COUNT > 0u) */
...
uint8 CapSense_1_GetDebounce(uint32 widget)
{
...
#if (CapSense_1_RAW_FILTER_MASK != 0u)
    /*******************************************************************************
    * Function Name: CapSense_1_EnableRawDataFilters
    ********************************************************************************
    *
    * Summary:
    ...
    *
    * Global Variables:
    *  CapSense_1_enableRawFilters defines if the filters are enabled or not.
    *
    * Side Effects:
    *  None
    *
    *******************************************************************************/
    ...
    {
        CapSense_1_enableRawFilters = CapSense_1_RAW_FILTERS_ENABLED;
    }

    /*******************************************************************************
    * Function Name: CapSense_1_DisableRawDataFilters
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        CapSense_1_enableRawFilters = CapSense_1_RAW_FILTERS_DISABLED;
    }
#endif /* (CapSense_1_RAW_FILTER_MASK != 0u) */
