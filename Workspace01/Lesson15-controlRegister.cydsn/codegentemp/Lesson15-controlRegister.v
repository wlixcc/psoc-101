// ======================================================================
// Lesson15-controlRegister.v generated from TopDesign.cysch
// 12/26/2019 at 13:45
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_101 or Net_134 or Net_103 or Net_137 or Net_111)
        begin
            case (Net_111[1:0])
                2'b00 :  tmp__mux_1_reg = Net_101;
                2'b01 :  tmp__mux_1_reg = Net_134;
                2'b10 :  tmp__mux_1_reg = Net_103;
                2'b11 :  tmp__mux_1_reg = Net_137;
            endcase
        end
        assign Net_110 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    defparam Control_Reg.BusDisplay = 1;
    defparam Control_Reg.ExtrReset = 0;
    defparam Control_Reg.NumOutputs = 2;
