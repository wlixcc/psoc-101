...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* ledcapsense service */
    {
        0x0010u, /* Handle of the ledcapsense service */ 
        {

            /* led characteristic */
            {
                0x0012u, /* Handle of the led characteristic */ 
            ...
            {
                0x0015u, /* Handle of the capsense characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0016u, /* Handle of the capsensecccd descriptor */ 
