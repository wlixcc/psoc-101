...
#define CYBLE_LEDCAPSENSE_SERVICE_HANDLE   (0x0010u) /* Handle of ledcapsense service */
#define CYBLE_LEDCAPSENSE_LED_DECL_HANDLE   (0x0011u) /* Handle of led characteristic declaration */
#define CYBLE_LEDCAPSENSE_LED_CHAR_HANDLE   (0x0012u) /* Handle of led characteristic */
#define CYBLE_LEDCAPSENSE_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_LEDCAPSENSE_CAPSENSE_DECL_HANDLE   (0x0014u) /* Handle of capsense characteristic declaration */
#define CYBLE_LEDCAPSENSE_CAPSENSE_CHAR_HANDLE   (0x0015u) /* Handle of capsense characteristic */
#define CYBLE_LEDCAPSENSE_CAPSENSE_CAPSENSECCCD_DESC_HANDLE   (0x0016u) /* Handle of capsensecccd descriptor */
#define CYBLE_LEDCAPSENSE_CAPSENSE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */
