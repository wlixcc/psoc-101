    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x31u] = {
    /* Device Name */
...
const uint8 cyBle_attUuid128[][16u] = {
    /* ledcapsense */
    { 0x00u, 0x2Du, 0x94u, 0xC2u, 0x26u, 0xC2u, 0x13u, 0xBFu, 0xE6u, 0x4Fu, 0x98u, 0xAEu, 0x46u, 0x5Du, 0xD3u, 0xFBu },
    /* led */
    { 0x61u, 0xB1u, 0xF9u, 0xBEu, 0xF9u, 0x42u, 0x6Fu, 0x87u, 0xC4u, 0x47u, 0xA8u, 0x6Fu, 0x94u, 0x2Bu, 0xDFu, 0xB1u },
    /* capsense */
    { 0xC2u, 0xD6u, 0xF1u, 0xABu, 0x49u, 0x7Bu, 0x52u, 0x98u, 0x10u, 0x4Eu, 0xDAu, 0xE5u, 0x60u, 0x91u, 0x3Du, 0x06u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[22] }, /* led */
    { 0x0009u, (void *)&cyBle_attValues[23] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* capsense UUID */
    { 0x0002u, (void *)&cyBle_attValues[32] }, /* capsense */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* capsensecccd */
    { 0x000Fu, (void *)&cyBle_attValues[34] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x17u] = {
    ...
    { 0x0012u, 0x2B94u /* led                                 */, 0x090A0101u /* rd,wr  */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
    ...
    { 0x0015u, 0x9160u /* capsense                            */, 0x09120001u /* rd,ntf */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[12]}} },
