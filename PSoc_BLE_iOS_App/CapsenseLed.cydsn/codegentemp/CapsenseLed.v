...
module BLE_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("a734a299-b266-4c35-b410-1944115b9213/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module CapSense_CSD_P4_v2_60_3 ;
	...
	cy_clock_v1_0
		#(.id("309367de-1137-4d95-ae63-bcfcf24fd259/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("309367de-1137-4d95-ae63-bcfcf24fd259/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("309367de-1137-4d95-ae63-bcfcf24fd259/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("309367de-1137-4d95-ae63-bcfcf24fd259/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("362564f3-312f-4807-92f3-29fb998ade3c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_4 = ~Net_114;


	cy_clock_v1_0
		#(.id("198a47dd-8d46-44f5-a382-aa8f93b7d7ff"),
		  .source_clock_id(""),
		  .divisor(0),
